...
# ==========================================
# AUTHENTICATION CONFIGURATION (CON ALLAUTH ACTUALIZADO)
# ==========================================
...
# CONFIGURACIÓN NUEVA (reemplaza las obsoletas)
ACCOUNT_LOGIN_METHODS = ['email']  # Reemplaza ACCOUNT_AUTHENTICATION_METHOD
ACCOUNT_SIGNUP_FIELDS = ['email*', 'password1*', 'password2*']  # Reemplaza EMAIL_REQUIRED y USERNAME_REQUIRED

# Otras configuraciones de allauth
